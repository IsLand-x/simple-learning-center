...
export const READER_AI_PROMPT_TEMPLATES = [
  {
    ...
    label: '生成信息图',
    prompt:
      '请使用信息图工具，把当前引用（没有引用时使用当前章节）制作成一张信息图。根据我想解决的问题自动选择合适的图型，先展示内容稿与来源对应，再生成绘图提示词和图片。区分原文、原文概括和补充解释；内容过多时建议拆图，不缩小字号。',
  },
  {
    id: 'book-knowledge-map',
    label: '全景知识地图',
    prompt:
      '请使用全景知识地图工具，逐段分析本书全部已提取正文，生成一张全景知识地图图片，讲清全书主题、作者核心观点、论据、观点之间的关系与含义，并标注章节出处和覆盖限制。',
  },
  {
    id: 'summarize-book',
    label: '总结全书',
