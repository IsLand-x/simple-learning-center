import { demoBooks } from '../fixtures/demo';
import { DEFAULT_READER_AI_ASSISTANT_PROMPT } from '../ai/readerAiPrompts';
import { DEFAULT_READER_CUSTOM_STYLE } from '../reading/readerThemes';
import type {
  AiPreferences,
  ReaderPreferences,
  RssDigestSettings,
