...
export function ReaderAiSettingsForm({
  ...
  return (
    <form
      className="ai-assistant-settings [margin-right:auto] [margin-left:auto] [gap:20px] [padding:20px] [background:var(--semi-color-bg-1)] mobile:[padding:14px]"
    ...
    >
      ...
      <label className="settings-field min-w-0 [gap:6px] [@media(max-width:860px)]:[grid-column:1_/_-1] ai-assistant-settings__field">
      ...
      >
        ...
        <div
          className="ai-assistant-settings__shortcut-list [border-top:1px_solid_var(--semi-color-border)]"
          role="list"
        >
          {READER_AI_PROMPT_TEMPLATES.map((template) => {
            ...
            return (
              <div
                className="ai-assistant-settings__toggle min-w-0 justify-between [gap:16px]"
                key={template.id}
                role="listitem"
              >
                <div className="ai-assistant-settings__toggle-copy min-w-0 [gap:2px] overflow-hidden">
      ...
      <section className="ai-assistant-settings__section">
        <div className="ai-assistant-settings__toggle min-w-0 justify-between [gap:16px]">
          <div className="ai-assistant-settings__toggle-copy min-w-0 [gap:2px] overflow-hidden">
