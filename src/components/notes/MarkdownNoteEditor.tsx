...
export function MarkdownNoteEditor({ ariaLabel, content, onChange }: MarkdownNoteEditorProps) {
  ...
  return (
    <div className="tiptap-markdown-editor min-h-0 overflow-hidden [background:var(--semi-color-bg-0)]">
      <div
        aria-label="Markdown 格式工具"
        className="tiptap-markdown-editor__toolbar [min-height:34px] [gap:1px] [padding:2px_4px] overflow-x-auto [background:var(--semi-color-bg-1)] [scrollbar-width:none]"
        role="toolbar"
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="tiptap-markdown-editor__divider [width:1px] [height:16px] [margin:0_3px] [background:var(--semi-color-border)]"
        />
      ...
      <EditorContent
        className="tiptap-markdown-editor__content min-h-0 [cursor:text]"
        editor={editor}
      />
    </div>
  );
