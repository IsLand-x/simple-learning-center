...
import { useOAuthProviders, oauthProviderLabels } from '../hooks/useOAuthProviders';
...
export function OAuthProviders() {
  ...
  return (
    <section className="oauth-providers" aria-label="OAuth 账号登录">
      ...
      {providers.map((provider) => {
        ...
        return (
          <article className="api-config-card oauth-provider" key={provider.id}>
            ...
            {pending && (
              <div className="oauth-provider__authorization" aria-live="polite">
