...
import { requestOpenApiToken, type OpenApiTokenStatus } from '../application/openApiToken';
...
export function OpenApiSettings() {
  ...
  return (
    <section className="account-settings openapi-settings" aria-labelledby="openapi-settings-title">
      ...
      {status?.token && (
        <div className="openapi-settings__token">
      ...
      <div className="openapi-settings__actions">
        <Button
          theme="solid"
