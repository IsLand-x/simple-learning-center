...
export function AccountSettings() {
  ...
  return (
    ...
    >
      ...
      <div className="account-settings__fields [grid-template-columns:minmax(0,_1fr)] [gap:16px] [@media(max-width:720px)]:[grid-template-columns:minmax(0,_1fr)]">
      ...
      <div className="account-settings__footer justify-between [gap:16px]">
        <Text size="small" type="tertiary">
      ...
      <div className="account-settings__logout [padding-top:20px] [border-top:1px_solid_var(--semi-color-border)]">
        <Button
          block
