...
export function ContentSourceSettings() {
  ...
  return (
    <section
      className="content-source-settings [margin-right:auto] [margin-left:auto] [padding:18px] [background:var(--semi-color-bg-1)]"
      aria-labelledby="content-source-settings-title"
    >
      <div className="content-source-settings__heading justify-between [gap:16px]">
        <div className="content-source-settings__identity min-w-0 [color:var(--semi-color-text-1)]">
      ...
      <form className="content-source-settings__form" onSubmit={save}>
        ...
        <div className="content-source-settings__actions justify-end">
          {status?.configured ? (
            <Button
              type="danger"
              theme="borderless"
