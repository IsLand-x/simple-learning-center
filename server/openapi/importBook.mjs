...
import { readEpubMetadata } from './epub.mjs';

const MAX_IMPORT_BYTES = 100 * 1024 * 1024;

export async function importBook(request, fileName) {
  ...
  try {
    await writeRequestToFile(Readable.fromWeb(request.body), path, MAX_IMPORT_BYTES);
