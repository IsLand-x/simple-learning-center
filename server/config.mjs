...
export const USERNAME = process.env.LEARNING_CENTER_USERNAME || 'reader';
export const PASSWORD = process.env.LEARNING_CENTER_PASSWORD || '';
...
export function validateServerConfig() {
  ...
  if (MODE === 'remote' && !PASSWORD) {
    throw new Error('远程模式必须设置 LEARNING_CENTER_PASSWORD');
  }
}
